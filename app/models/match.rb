class Match < ApplicationRecord
 ...
 def self.Cricket
  ...
  def push_data
    @data = process_data
    @data.each do |player|
      Match.create(date: player['date'], location: player['location'], team1_id: player['team1_id'], team2_id: player['team2_id'], score_team1: player['score_team1'], score_team2: player['score_team2'])
    end
  end
end
# Usage
